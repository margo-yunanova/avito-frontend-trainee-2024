...
> [!IMPORTANT]
> В соответствии с документацией в `json-server: ^1.0.0-beta.2` отсутствует api для поиска по подстроке.
> В связи с этим реализован поиск по точному совпадению по наименованию объявления.
