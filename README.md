...
Данное приложение разработано в рамках выполнения профильного задания - Фронтенд-разработчик на стажировку в Авито.
...
|[json-server](https://mswjs.io/)|Библиотека, позволяющая получить полный моковый REST API.|

## Реализовано

Выполненный объем работ отмечен в техническом задании.

> [!IMPORTANT]
> В `json-server: ^1.0.0-beta.2` пока не реализован фильтр по подстроке, поэтому пришлось сделать только фильтр по полному названию карточки.
> В продакшн версии бэкенд естественно должен фильтровать карточки товаров по подстроке без учета регистра.
...
1. [x] Страницы объявления
2. [x] Страницы всех объявлений
3. [x] Страницы заказов
4. [x] Панели навигации

#### На странице всех объявлений:
1. [x] Отображается список всех объявлений продавца
...
5. [x] Можно перейти на страницу объявления (по клику на карточку)
6. [x] В карточке объявления есть следующая информация о нем:
   - Картинка
   - Название;
   - Стоимость;
   - Количество просмотров;
   - Количество лайков;
7. [x] Есть возможность создавать новые объявления (Модальное окно с input):
   - Картинка (текстовое поле для ввода URL);
   - Название (текстовое поле);
   - Описание (текстовое поле)
   - Стоимость (числовое поле);
#### На странице объявления:
1. [x] Есть возможность просмотра объявления
2. [x] В редактировании объявления есть возможность:
   - Менять картинку;
   - Менять название;
   - Менять цену;
   - Менять описание.
#### На странице заказов:
1. [x] Отображается список заказов с фильтрами по статусу
2. [x] Возможно сделать сортировку по сумме заказа
3. [x] На карточке заказа изображена следующая информация:
   - Количество товаров;
...
4. [x] При клике на товар в заказе есть возможность перейти в объявление продавца по этому товару
#### Панель навигации:
1. [x] Вкладка “Объявления” - реализован переход на страницу объявлений
2. [x] Вкладка “Заказы” - реализован переход на страницу заказов
